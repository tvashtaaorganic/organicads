...
export default function HtaccessRedirectGenerator() {
  ...
  const handleInputChange = (index: number, field: "sourceUrl" | "destinationUrl" | "redirectType", value: string) => {
  ...
  const shareOnWhatsApp = () => {
    const message = `Check out this awesome .htaccess Redirect Generator:\n\nhttps://yourwebsite.com/htaccess-redirect-generator`;
    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 mt-10 max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="md:col-span-8 bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mt-12 prose max-w-none opacity-100">
          <h2 className="text-2xl font-semibold mb-4">About .htaccess Redirect Generator</h2>
          <div className="space-y-4">
            <p>
              Our .htaccess Redirect Generator is a user-friendly tool designed to help you create redirect rules for your Apache server’s .htaccess file. It supports various redirect types like 301 (permanent), 302 (temporary), and 410 (gone), making it easy to manage URL redirections for SEO, site migrations, or page deletions.
            </p>
            <h3 className="text-xl font-medium">Features:</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Multiple Redirect Types:</strong> Generate 301, 302, 303, 307, or 410 redirects.
              </li>
              <li>
                <strong>Batch Creation:</strong> Add multiple redirects at once.
              </li>
              <li>
                <strong>Simple Interface:</strong> Input source and destination URLs with ease.
              </li>
              <li>
                <strong>Copy & Reset:</strong> Copy rules to clipboard or reset the form instantly.
              </li>
            </ul>
            <h3 className="text-xl font-medium">Common Uses:</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>SEO-friendly site migrations</li>
              <li>Redirecting old URLs to new ones</li>
              <li>Handling deleted pages (410 Gone)</li>
              <li>Temporary redirects for maintenance</li>
              <li>Domain changes</li>
            </ul>
            <h3 className="text-xl font-medium">How to Use:</h3>
            <ol className="list-decimal pl-6 space-y-2">
              <li>Enter the source URL (e.g., /old-page.html).</li>
              <li>Enter the destination URL (e.g., /new-page.html).</li>
              <li>Select the redirect type (e.g., 301).</li>
              <li>Add more redirects if needed.</li>
              <li>Click \"Generate\" to create the .htaccess rules.</li>
              <li>Use \"Copy to Clipboard\" or \"Reset\" as needed.</li>
            </ol>
            <p>
              This tool simplifies the process of generating accurate redirect rules, saving you time and reducing errors. It\'s perfect for web developers, SEO professionals, and site administrators managing URL structures.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="md:col-span-4 bg-white p-6 rounded-lg shadow-md space-y-6">
        <div className="bg-blue-100 rounded-lg p-4">
          ...
          <ul className="text-sm space-y-2">
            ...
            <li>• Results update on generate</li>
            <li>• Copy rules directly to your .htaccess file</li>
          </ul>
        </div>
        <div className="bg-muted rounded-lg p-4">
          <h4 className="font-semibold mb-2">Tool Stats</h4>
          <p className="text-sm">Trusted by web developers</p>
          <p className="text-xs mt-1 text-muted-foreground">Over 5,000 redirects generated daily</p>
        </div>
